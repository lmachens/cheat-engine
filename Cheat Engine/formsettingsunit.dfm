    ...
    object pcSetting: TPageControl
      ...
      object GeneralSettings: TTabSheet
        ...
        object cbCenterOnPopup: TCheckBox
          ...
          Width = 601
          Height = 21
          Caption = 'Center DLH when bringing to front'
          Checked = True
          State = cbChecked
          TabOrder = 2
        end
        object EditUpdateInterval: TEdit
          ...
          Height = 24
          Hint = 
            'The number of milliseconds that DLH will wait before re' +
      ...
      object CodeFinder: TTabSheet
        ...
        object Label4: TLabel
          ...
          Align = alTop
          Caption = 
            'There are 2 ways DLH can find the addresss of code that' +
